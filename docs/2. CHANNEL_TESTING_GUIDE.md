...
This testing guide uses HexChat. More information on how to set up the client to connect to our server can be found in the general README.md.
...
| `/invite nick #name` | Invite user | `/invite billie #test` |
...
- The first person to join a channel is usually the operator. You can recognize them by the green dot. 


---

## Extended Channel Command Tests
...
/join #mychannel
```
Everyone sees: `* billie has joined #mychannel`
...
Alice and Bob see: `* billie has left #mychannel`
...
Now Alice is in both, Bob in #channel1, Billie in #channel2!
...
**Alice:**
```
/invite billie #mychannel
```

Billie receives an invite to join #mychannel.
